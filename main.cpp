...
// *******************************************************************
// * Name: main *
// * Description: The main routine to test the Assignment #8 Link *
// * Lis assignment. Do not alter this source code other than *
// * to comment out the member functions that you have not. *
// * implemented yet. Details on the test: *
// * 1. Declare a link list using the Default Constructor. *
// * 2. Test to see if the list is empty. *
// * 3. Open the file. *
// * 4. Use Propogate to read the file and insert records into the *
// * list. *
...
// ******************************************************************
// * Name: OpenFile *
// * Description: Asks the user for name name of a file and *
// * opens it. Returns the pointer to the file as a parameter. *
// * Author: Dr. David A. Gaitros * // *
...
// * Description: Accepts a file stream parameter and a LinkList *
// * parameter and reads a record one at a time and inserts into *
// * the list calling Insert() method from the LinkList class. *
// * Author: Dr. David A. Gaitros *
